  ...
  ngOnInit(): void {
    ...
    this.routerSub = this.router.events
      ...
      .subscribe((event) => {
        ...
        this.hiddenNavbar = this.currentRoute.includes('auth/login') || this.currentRoute.includes('auth/restore') || this.currentRoute.includes('admin') || this.currentRoute.includes('auth/register');
